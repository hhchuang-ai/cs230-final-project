...
class ImageData:
    ...
    def image_processing(self, filename):
        ...
        #TODO():Also apply decode_png since we have png files too. USe tf.io.decode_image instead ?
        x_decode = tf.image.decode_jpeg(x, channels=self.channels)
        img = tf.image.resize_images(x_decode, [self.load_size, self.load_size]) # 256 * 256 * 3 
